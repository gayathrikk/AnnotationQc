...
public class annotationqc {
	   private RemoteWebDriver driver;
	    ...
	    public void gapFinding() throws InterruptedException {
	        ...
	        try {
	            WebDriverWait wait = new WebDriverWait(driver, 30);
	            WebElement num1 = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//span[text()='90,069.52']")));
	            num1.click();
	            Thread.sleep(5000);
	        ...
	        try {
	            WebDriverWait wait = new WebDriverWait(driver, 30);
	            WebElement num2 = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//td[text()='171,368.65']")));
	            num2.click();
	            Thread.sleep(5000);
	            System.out.println("The Number clicked Successfully");
	        } catch (Exception e) {
